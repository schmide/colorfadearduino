...
bool UpdateColor(bool on)
{
   ...
   DOTTYPE vectDot = (DOTTYPE)(dest.r - currentColor.r) * deltaColorDirection.r;
   vectDot += (DOTTYPE)(dest.g - currentColor.g) * deltaColorDirection.g;
   vectDot += (DOTTYPE)(dest.b - currentColor.b) * deltaColorDirection.b;
   if ( vectDot <= 0 ) {
      currentColor = dest;
      return false;
   } else {
